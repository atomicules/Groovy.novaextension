...
💡 Quick Tip! As you edit this README template, you can preview your changes by selecting **Extensions → Activate Project as Extension**, opening the Extension Library, and selecting "Groovy" in the sidebar.
...
**Groovy** provides deep integration with **An Important Language**, including the most important feature, something that's really helpful, and _a little-known secret!_
...
- Select the **Editor → Groovy** menu item; or
- Open the command palette and type `Groovy`
